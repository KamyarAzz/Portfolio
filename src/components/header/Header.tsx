...
export default function Header() {
  ...
  const enterLangHoverHandler = (text: string) => {
    if (openLang) setTooltip({isVisible: true, text: text});
  };
      ...
      <div className="flex flex-row items-end justify-end gap-3 text-lg md:gap-4">
          ...
          >
            <div className="flex flex-col items-center justify-center gap-5">
              {availableLangs.map((flag: TFlag) => (
                <img
                  onMouseEnter={() => enterLangHoverHandler(flag.name)}
        ...
        >
          <svg
            ...
            className="block transition-transform duration-100 cursor-pointer dark:hidden hover:-rotate-12"
          ...
          <svg
            ...
            className="hidden transition-transform duration-100 cursor-pointer dark:block hover:-rotate-12"
            onMouseEnter={() => addHover("first")}
            onMouseLeave={removeHover}
          ...
          <div
            className={cn(
              openCV
                ...
                : "h-0 opacity-0 scale-95",
              "absolute dark:shadow-dropdown-dark shadow-dropdown-light overflow-hidden -top-1.5 w-full bg-lightBg dark:bg-darkCharcoal pb-3 rounded-full pt-14 px-5 transition-all duration-300 ease-in-out transform"
            )}
          >
            <div className="flex flex-col items-center justify-center gap-5">
              <a
